...
test = let 
         ...
         left = (Leaf (Word "left") (For BS DP S))
         john = (Leaf (Word "John") DP)
         mary = (Leaf (Word "Mary") DP)
         someone = (Leaf (Word "someone") (For FF S (For BB DP S)))
         loves = (Leaf (Word "loves") (For FS (For BS DP S) DP))
         everyone = (Leaf (Word "everyone") (For FF S (For BB DP S)))
         read = (Leaf (Word "read") (For FS (For BS DP S) DP))
         the = (Leaf (Word "the") (For FS DP N))
